            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex flex-col lg:flex-row px-5 py-24 items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 className="title-font sm:text-4xl lg:text-5xl text-3xl mb-4 font-medium text-gray-900">
                            Dr. Merry Stone — Licensed Mental Health Counselor, Psychotherapist
                        </h1>
                        <p className="mb-8 leading-relaxed lg:text-xl md:text-lg text-base">
